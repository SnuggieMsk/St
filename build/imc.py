...
<section id="diligence">
  ...
  <div class="grid c2">
    <div class="card pos">
      ...
      <ul class="check" style="margin-bottom:0">
        <li>Pothen-family-led promoter group holds 89.81% (2022 disclosure){ref("72")}</li>
        <li>Public float ~10.19% &mdash; functionally illiquid (Bloomberg Z-suffix indicates limited trading){ref("78")}</li>
        <li>90-year operating history; promoter group stable through multiple sector cycles</li>
        <li>Philip Pothen transitioned from CEO role to director; nominee director at Imcola Gas from Feb 2019{ref("76")}</li>
        <li>Pledge status: not in public domain; due to illiquid float, effectively no pledge market</li>
        <li>Family-led governance model; short credit-decision cycle (2&ndash;3 weeks)</li>
      </ul>
    </div>
    <div class="card">
      <h4 style="margin-top:0">Related-party &amp; group network</h4>
      <ul class="check" style="margin-bottom:0">
        <li>Directors overlap across IMC + ETTPL (JV) + Imcola Gas + Sholagasco brands</li>
        <li>Related-party transactions at arm&rsquo;s length; ETTPL JV revenue Rs 283 Cr flows via AS-18 disclosure{ref("75")}</li>
        <li>Sholagasco / Imcola brand entities: LPG distribution adjacency</li>
        <li>No NCLT / material litigation exposure at any promoter-group entity per public-domain + Probe42 checks{ref("79,81,82")}</li>
        <li>No cross-border promoter entity; India-domiciled promoter group only</li>
      </ul>
    </div>
  </div>

  <h3>11.1b &mdash; KMPs, SBOs &amp; material shareholders (Probe42-verified, Apr 2026)</h3>
  <div style="overflow-x:auto">
  <table>
    <thead><tr><th>Category</th><th>Name / detail</th><th>Source</th></tr></thead>
    <tbody>
      <tr><td>Directors on current board (MCA DIR-12)</td><td>Philip Pothen, Munuswamy Balasubramanian, Jayaprakash Kalappan, Subramaniam Bala Mahadevan, Mallesh Rao Atluri, Robert Pavrey, Alla Bux Beerali</td><td>MCA Form DIR-12{ref("70")}</td></tr>
      <tr><td>Former CEO / continuing director</td><td>Philip Pothen</td><td>Public profile{ref("76")}</td></tr>
      <tr><td>CFO (Sec 203 KMP)</td><td>To be confirmed at MCA DIR-12 pull at T+14</td><td>Diligence item</td></tr>
      <tr><td>Company Secretary (Sec 203 KMP)</td><td>To be confirmed at T+14</td><td>Diligence item</td></tr>
      <tr><td>Significant Beneficial Owners (Form BEN-2)</td><td>Pothen family members individually above 10% threshold; family-branch split via BEN-2 filings</td><td>MCA Form BEN-2{ref("70")}</td></tr>
      <tr><td>Material shareholders (&gt;5%)</td><td>No widely-dispersed public &gt;5% given 89.81% promoter concentration</td><td>2022 disclosure{ref("72")}</td></tr>
      <tr><td><strong>Credit rating</strong> (Probe42 pull, 22 Apr 2026)</td><td><strong>CARE reaffirmed A+ Stable</strong> on Issuer Rating + LT Bank Facilities; rating action dated 10 Apr 2026</td><td>Probe42 credit-ratings{ref("81")}</td></tr>
      <tr><td><strong>Suit-filed cases</strong> (credit bureau, Probe42)</td><td><strong>ZERO</strong> &mdash; no Suit Filed Cases with any credit bureau</td><td>Probe42 suit-filed-cases{ref("82")}</td></tr>
    </tbody>
  </table>
  </div>
  <p><em>Diligence items:</em> (i) fresh MCA DIR-12 pull at T+14 for current CFO / CS names; (ii) BEN-2 filing verification for Pothen-family SBO declarations; (iii) cross-reference Imcola Gas director-network from Philip Pothen&rsquo;s other directorships.</p>
