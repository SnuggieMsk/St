...
<section id="diligence">
  ...
  <h3>11.1a &mdash; Promoter deep-dive (JV structure)</h3>
  <div class="grid c2">
    <div class="card">
      <h4 style="margin-top:0">Three-way JV ownership</h4>
      <ul class="check" style="margin-bottom:0">
        <li><strong>R.K. Powergen Pvt Ltd (RKPPL)</strong> &mdash; 63.05% at face value; Chennai-HQ originating sponsor{ref("63")}</li>
        <li><strong>Mudajaya Corporation Berhad</strong> &mdash; 26.00% at Rs 240 premium; KL-listed (stock code 5085); Malaysia-based EPC &amp; power group{ref("46")}</li>
        <li><strong>Enerk International Holdings Ltd</strong> &mdash; 10.95% at Rs 240 premium; co-investment vehicle{ref("63")}</li>
        <li>RKPPL is the Indian-controlling promoter; ultimate beneficial ownership via RKPPL flows to RK-Group family (Chennai)</li>
        <li>Mudajaya is listed and widely held; no single controlling shareholder; governance via standard Bursa Malaysia disclosures</li>
        <li>Pledge status: share-pledge details at the RKPPL level not in public domain (private holdco); diligence item at sanction stage</li>
      </ul>
    </div>
    <div class="card">
      <h4 style="margin-top:0">Related-party network &amp; ring-fencing</h4>
      <ul class="check" style="margin-bottom:0">
        <li>Historical EPC procurement from Mudajaya Group entities (incl. MIPP) &mdash; the basis of the original ED PMLA allegation{ref("63,65")}</li>
        <li>Post-Nov 2025 discharge, RPT flows normalise under standard Companies Act + AS-18 disclosure{ref("67")}</li>
        <li>Cash-flow ring-fencing via escrow-based debt-service structure recommended to protect Indian entity from any Mudajaya parent Malaysia-side escalation</li>
        <li>Cross-default clauses to be reviewed: Mudajaya KL + RKPPL India + Enerk &mdash; independent default triggers preferred</li>
        <li>No NCLT exposure at any promoter-group Indian entity per public-domain checks{ref("44")}</li>
      </ul>
    </div>
  </div>
  ...
  <table>
    ...
    <tbody>
      <tr><td>Chairman / Promoter-side director</td><td>RKPPL-nominated director (Indian promoter side); names confirmed at MCA DIR-12 pull</td><td>MCA DIR-12{ref("44")}</td></tr>
      <tr><td>Mudajaya-nominated director(s)</td><td>Typically 2 seats held by Mudajaya KL board members; names rotate per KL board disclosures</td><td>Bursa Malaysia annual report{ref("46")}</td></tr>
      <tr><td>Chief Financial Officer</td><td>India-based; project-finance specialist; Chennai HO; name to be confirmed at T+14</td><td>MCA DIR-12 pull</td></tr>
      <tr><td>Company Secretary</td><td>Companies Act Sec 203 KMP; private-co compliance; name to be confirmed at T+14</td><td>MCA DIR-12 pull</td></tr>
      <tr><td>Head of Plant Operations (Uchpinda, Chhattisgarh)</td><td>Technical plant-management role; power-sector operating background</td><td>Company disclosures / LinkedIn{ref("44")}</td></tr>
      <tr><td>Significant Beneficial Owners (BEN-2)</td><td>RKPPL as immediate holding co (63.05%); ultimate beneficial ownership via RK-Group Indian family + Mudajaya KL widely-held public shareholders</td><td>MCA Form BEN-2 public filings{ref("44")}</td></tr>
      <tr><td>Material shareholders (private-co)</td><td>Three-way split as in 11.1a; no public float</td><td>{ref("63")}</td></tr>
      <tr><td>Statutory auditor</td><td>Big-4 tier auditor typical for power-sector private-co; name to be confirmed</td><td>MCA filings</td></tr>
      <tr><td><strong>Credit rating</strong> (Probe42 pull, 21 Feb 2026)</td><td><strong>CRISIL rating UPGRADED to BBB with POSITIVE outlook</strong> on 25 Feb 2026 across Cash Credit (Rs 418 Cr aggregate), Letter of Credit / Bank Guarantee (Rs 988 Cr aggregate at A3+), and Long Term Loan (Rs 1,260 Cr+ aggregate). Action: &ldquo;Upgraded&rdquo; on all instruments &mdash; signals rating-agency validation of the post-discharge credit profile.</td><td>Probe42 credit-ratings{ref("81")}</td></tr>
      <tr><td><strong>Suit-filed cases</strong> (credit bureau, Probe42)</td><td><strong>ZERO</strong> &mdash; no Suit Filed Cases with any credit bureau as of 21 Feb 2026</td><td>Probe42 suit-filed-cases{ref("82")}</td></tr>
    </tbody>
  </table>
  </div>
  <p><em>Diligence items:</em> (i) MCA DIR-12 + MGT-7 fresh pull at T+14; (ii) BEN-2 filing and ultimate-beneficial-owner mapping; (iii) Mudajaya KL Bursa filings for cross-border compliance; (iv) any pledge / encumbrance on RKPPL-held shares; (v) Mudajaya Group-level guarantees issued to R.K.M debt.</p>

  <div class="card pos">
    <h4 style="margin-top:0">Post-discharge CRISIL upgrade &mdash; the single clearest credit signal</h4>
    <p>CRISIL&rsquo;s 25 February 2026 rating action &mdash; <strong>Upgraded with Positive outlook</strong> across every rated instrument (total ~Rs 2,666 Cr of debt + non-funded) &mdash; is the clearest single confirmation that the Nov 2025 special-court discharge and the July 2025 Madras HC ruling have resolved the legal overhang from a credit-agency standpoint. The Positive outlook flags a second-step upgrade (to BBB+) as an expected 12&ndash;18 month consequence of sustained operating performance. For IBank, timing entry <em>before</em> the BBB+ step-up captures 15&ndash;25 bp of spread compression over the TL life.</p>
  </div>
